<br><br>
<center><h1>THÊM BÀI VIẾT</h1></center>
<div class="container" style="background: white;">
    <div class="row">
        <div class="col col-12">
<form action="index.php?mod=post&act=new" method="post" enctype="multipart/form-data" id="UploadForm">
    <div class="form-group">
        <label for="forum-topic-name">Tên bài viết</label>
        <input type="text" class="form-control" id="forum-topic-name" name="forum_topic_name" placeholder="Nhập tên bài viết" required>
    </div>
    <div class="form-group">
        <label for="forum-topic-body">Nội dung bài viết</label>
        <textarea id="forum-topic-body" rows="9" class="form-control" placeholder="Nhập nội dung bài viết" name="forum_topic_body" required></textarea>
    </div>
    <div class="form-group">
...
OED;
    ...
    <hr>
    <label for="forum-topic-attachment">Ảnh</label>
